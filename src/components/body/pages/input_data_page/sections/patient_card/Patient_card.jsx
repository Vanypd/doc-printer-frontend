  ...
  return (
    <section className={cl.data}>
      ...
      <Block_division>
        ...
        <Data_selector value={patientData.patientСard.disability} setValue={dataSetter.setDisability} options={['Нет', 'I', 'II', 'III']} selectorStyle={{width: '150px'}} defaultLable={'Не выбрано'}/>
      </Block_division>
    </section>
  )
}
